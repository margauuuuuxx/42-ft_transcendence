...
export function setupFriendsRoutes(server) {
    server.post("/friends/request", async (req, reply) => {
        try {
    ...
    server.post("/friends/accept", async (req, reply) => {
        try {
    ...
    server.get("/friends", async (req, reply) => {
        try {
