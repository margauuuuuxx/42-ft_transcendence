...
export interface GridCell {
  ...
  rowStart: number;
  rowEnd: number;
  type?: 'menu' | 'image' | 'content' | 'empty';
}

/**
 * Generate Tailwind grid position classes
 */
export function getGridClasses(cell: GridCell): string {
...
export const GRID_LAYOUTS = {
  navbar: {
    ...
    rows: 2,
    cells: [
      { colStart: 1, colEnd: 3, rowStart: 1, rowEnd: 3, type: 'menu' as const }, // HOME vertical (2 cols, 2 rows)
      { colStart: 3, colEnd: 5, rowStart: 1, rowEnd: 2, type: 'menu' as const }, // PLAY (2 cols)
      { colStart: 5, colEnd: 11, rowStart: 1, rowEnd: 3, type: 'content' as const }, // TITLE (6 cols, 2 rows)
      { colStart: 11, colEnd: 13, rowStart: 1, rowEnd: 2, type: 'menu' as const }, // TOURNAMENT (2 cols)
      { colStart: 13, colEnd: 15, rowStart: 1, rowEnd: 2, type: 'menu' as const }, // LEADERBOARD (2 cols)
      { colStart: 15, colEnd: 17, rowStart: 1, rowEnd: 2, type: 'menu' as const }, // PROFILE (2 cols)
      { colStart: 3, colEnd: 5, rowStart: 2, rowEnd: 3, type: 'menu' as const }, // SOCIAL (2 cols)
      { colStart: 11, colEnd: 13, rowStart: 2, rowEnd: 3, type: 'menu' as const }, // SETTINGS (2 cols)
      { colStart: 13, colEnd: 17, rowStart: 2, rowEnd: 3, type: 'menu' as const }, // LOGOUT (4 cols)
    ],
  },
};
